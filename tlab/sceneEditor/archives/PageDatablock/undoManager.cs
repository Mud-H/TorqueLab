//==============================================================================
// TorqueLab -> DatablockEditor Undo Manager
// Copyright (c) 2015 All Right Reserved, http://nordiklab.com/
//------------------------------------------------------------------------------
//==============================================================================
/*
//==============================================================================
function SceneEd::createUndo( %this, %class, %desc ) {
	pushInstantGroup();
...
//------------------------------------------------------------------------------
//==============================================================================
function SceneEd::submitUndo( %this, %action ) {
...
function ActionCreateDatablock::redo( %this ) {
	%db = %this.db;
	%db.name = %this.dbName;
	%this.editor.DBPM.setDirty( %db, %this.fname );
...
function ActionCreateDatablock::undo( %this ) {
	...
	%this.editor.DBPM.removeDirty( %db );
	%this.dbName = %db.name;
	%db.name = "";
...
function ActionDeleteDatablock::redo( %this ) {
	...
	if( %db.getFileName() !$= "" )
		%this.editor.DBPM.removeObjectFromFile( %db );
