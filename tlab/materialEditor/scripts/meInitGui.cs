...
//==============================================================================
function MaterialEditorTools::establishMaterials(%this,%forced) {
...
//------------------------------------------------------------------------------
//==============================================================================
function MaterialEditorTools::open(%this) {
	...
	//MaterialEditorTools.updateAllFields();
	MaterialEditorTools.updatePreviewObject();
	...
	if( MaterialEditorTools.currentMode $= "Mesh" )
		MaterialEditorTools.prepareActiveObject( true );
	else
		MaterialEditorTools.prepareActiveMaterial( "", true );
